...
gulp.task("templates:single", function() {
    return gulp
        .src(["src/templates/*.pug", "!src/templates/layout.pug"], { since: gulp.lastRun("templates:single") })
        .pipe(pug({ pretty: true }))
        .on("error", function(err) {
...
gulp.task("watch", function() {
    gulp.watch(["src/templates/layout.pug", "src/templates/includes/**/*.*"], gulp.series("templates:all", "reload"));
